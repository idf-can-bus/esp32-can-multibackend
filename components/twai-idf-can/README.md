...
The ESP32 TWAI controller requires a CAN transceiver to interface with the physical CAN bus. Common transceivers:

- **SN65HVD230** (3.3V, recommended for ESP32)
- **TJA1050** (5V, requires level shifters)
- **MCP2551** (5V, requires level shifters)
...
**Important Notes:**
- A **120-ohm termination resistor** must be placed at **each end** of the CAN bus
